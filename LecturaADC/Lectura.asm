			...
			BSF		ANSEL,ANS5		;Selección de entrada analogica para activar
    		CLRF    ANSELH			;Se escribe 0x00 en el registro indicado (ANSELH)	    1ciclo
    	
    		BANKSEL	ADCON1		;Banco 1
			MOVLW	0x80			;Justificación a la derecha. 
			MOVWF	ADCON1		
...
MAIN:		CALL 	SampleTime
			...
			BANKSEL	ADRESL			;Ubicación banco1
			MOVF	ADRESL,W		;Se carga el valor en W
			BANKSEL	ADRESH			;Ubicación banco0
